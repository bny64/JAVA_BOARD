define([], function(){
	...
	function Module(){
		...
		const pandora = new arguments[0](arguments);
...
(function() {
	...
	$("#birth").datepicker({
		onSelect : function() {
			...
			if (that.value !== '')
				...
				domUtil.removeClass(that, 'has-val');
		}
	});
	...
	*//**
	...
	const inputList = document
			.querySelectorAll('[data-validate].validate-input .input100');
	...
	joinForm.addEventListener('submit', function(e) {
		...
		if (document.activeElement !== document
				.querySelector('.login100-form-btn#joinBtn'))
			return;
